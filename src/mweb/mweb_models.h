// Copyright(C) 2011 - 2020 The Metaworldcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef METAWORLDCOIN_MWEB_MODELS_H
#define METAWORLDCOIN_MWEB_MODELS_H
...
#endif // METAWORLDCOIN_MWEB_MODELS_H