...
{
    const char* pszTimestamp = "Metaverse is coming... We may already be in it...";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1670672489, 565168, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xed2380ef8d7fe72ae6d92a139db3f373364a0f5607a1368f4abcee3218f569ff"));
        assert(genesis.hashMerkleRoot == uint256S("0x482bab1b29a649d10d404f225f59c899714400a99495b5ec8f3f93bf727bd6a1"));
        ...
        // vSeeds.emplace_back("seed-a.metaworldcoin.loshan.co.uk");
        // vSeeds.emplace_back("dnsseed.thrasher.io");
        // vSeeds.emplace_back("dnsseed.metaworldcointools.com");
        // vSeeds.emplace_back("dnsseed.metaworldcoinpool.org");
        ...
        checkpointData = {
            {
                {  1500, uint256S("0xed2380ef8d7fe72ae6d92a139db3f373364a0f5607a1368f4abcee3218f569ff")}
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x4a280c0e150e3b74ebe19618e6394548c8a39d5549fd9941b9c431c73822fbd5"); //1174621
        ...
        vSeeds.emplace_back("testnet-seed.metaworldcointools.com");
        vSeeds.emplace_back("seed-b.metaworldcoin.loshan.co.uk");
        ...
        checkpointData = {
            {
                {2056, uint256S("ed2380ef8d7fe72ae6d92a139db3f373364a0f5607a1368f4abcee3218f569ff")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        checkpointData = {
            {
                {0, uint256S("ed2380ef8d7fe72ae6d92a139db3f373364a0f5607a1368f4abcee3218f569ff")},
            }
        };
