...
#if defined(NDEBUG)
# error "Metaworldcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Metaworldcoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("metaworldcoin-scriptch");
