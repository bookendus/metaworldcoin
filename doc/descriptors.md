# Support for Output Descriptors in Metaworldcoin Core

Since Metaworldcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Metaworldcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Metaworldcoin Core wallets, a convenience function `combo` is
