Metaworldcoin Core version *0.15.1* is now available from:

  <https://download.metaworldcoin.org/metaworldcoin-0.15.1/>
...
A number of changes to the way Metaworldcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 millms per kB (0.00001 MWC). This is to prepare for dropping the minimum transaction fee to 0.1 millms per kB (0.0001 MWC) in the next release.
