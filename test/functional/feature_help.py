...
"""Verify that starting metaworldcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start metaworldcoin with -h for help text")
        ...
        self.log.info("Start metaworldcoin with -version for version information")
        ...
        self.log.info("Start metaworldcoind with -fakearg to make sure it does not start")
