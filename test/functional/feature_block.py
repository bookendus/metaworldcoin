...
class FullBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        #                        \-> b68 (20)
        #
        # b68 - coinbase with an extra 10 atoms,
        #       creates a tx that has 9 atoms from out[20] go to fees
        #       this fails because the coinbase is trying to claim 1 satoshi too much in fees
        #
        # b69 - coinbase with extra 10 atoms, and a tx that gives a 10 satoshi fee
        #       this succeeds
        #
